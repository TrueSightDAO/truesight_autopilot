...
ROLE_ALIASES: dict[str, str] = {
    ...
    "4": "retailer_outreach",
    "outreach": "retailer_outreach",
    "retailer": "retailer_outreach",
    "retail": "retailer_outreach",
    "5": "logistics",
    "import": "logistics",
    "export": "logistics",
    "freight": "logistics",
...
def get_tool_schemas_for_role(role: Role | None) -> list[dict[str, Any]]:
    ...
    # read_tool_result (read an offloaded result), recall_context ("really look
    # back" in this thread), pin_note (pin a working-set note that survives
    # trim/compaction).
    allowed = set(role.tools) | {"read_tool_result", "recall_context", "pin_note"}

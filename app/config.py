...
class Settings(BaseSettings):
    ...
    api_only_repos: list[str] = [
        ...
        "treasury-cache", "places-cache", "contributors-cache",
        # machine-appended logs / records
        "truesight_autopilot_transcript", "oracle_logs",
        "lineage-credentials", "ecosystem_change_logs",
        # blob / asset stores (Contents-API uploads)
        ".github", "qr_codes", "sunmint",
        "store_interaction_attachments", "lineage-assets",
